...
from data import transform_application_table, transform_bureau_tables, transform_previous_and_pos_cash, transform_credit_card_balance
...
train_df = df_train_tf.merge(final_bureau_table, on='SK_ID_CURR', how='left').merge(previous_app_tf, on='SK_ID_CURR', how='left').merge(credit_card_tf, on='SK_ID_CURR', how='left')
test_df = df_test_tf.merge(final_bureau_table, on='SK_ID_CURR', how='left').merge(previous_app_tf, on='SK_ID_CURR', how='left').merge(credit_card_tf, on='SK_ID_CURR', how='left')
